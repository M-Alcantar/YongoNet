    ...
    <div class="w-full max-w-md space-y-3">
        ...
        <form action="?/login" method="POST" class="space-y-4">
            ...
            <div class="flex items-center space-x-4">
                <button
                    type="submit"
                    class="group relative flex-auto justify-center rounded-md my-4 bg-[#0087e8] px-4 py-2 text-base font-semibold text-white shadow-sm hover:bg-[#046bbf] focus:ring-offset-0 focus:ring-transparent"
                >
                    Log in
                </button>
